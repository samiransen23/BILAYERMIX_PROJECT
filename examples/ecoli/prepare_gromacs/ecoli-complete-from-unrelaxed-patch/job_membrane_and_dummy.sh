...
INPUT_PATH="/Users/samiransen23/BILAYERMIX_PROJECT/examples/ecoli/build_input/ecoli-complete-from-unrelaxed-patch"
...
cp -r ${INPUT_PATH}/{index.ndx,out_ecoli_centred.gro} topol.top toppar mdp ${SCRATCH}/.
cd $SCRATCH
mkdir -p out
...
gmx grompp -f mdp/step6.0_minimization.mdp -p topol.top -n index.ndx -c out_ecoli_centred.gro -o out/step6.0_minimization.tpr
