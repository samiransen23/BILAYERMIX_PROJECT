...
STEP1_OUTPUT_PATH="/cluster/projects/nn4654k/samiran/BILAYERMIX_PROJECT/examples/ecoli/prepare_gromacs/ecoli-complete-from10.3x10.3x8.5/controlledelongation/step1_NPT/gromacs_out"
# modify topol.top
...
#extract 60th frame = 120ps
echo -e "0 \n q" | gmx trjconv -f ${STEP1_OUTPUT_PATH}/step6.2_equilibration.xtc -s ${STEP1_OUTPUT_PATH}/step6.2_equilibration.tpr -b 119 -e 120 -o step6.2_equilibration_120ps.gro

cp -r ${INPUT_PATH}/index.ndx step6.2_equilibration_120ps.gro topol.top toppar mdp ${SCRATCH}/.
cd $SCRATCH
mkdir -p out
...
gmx grompp -f mdp/step6.2_equilibration.mdp -p topol.top -n index.ndx -c step6.2_equilibration_120ps.gro -r step6.2_equilibration_120ps.gro -o out/step6.2_equilibration.tpr
