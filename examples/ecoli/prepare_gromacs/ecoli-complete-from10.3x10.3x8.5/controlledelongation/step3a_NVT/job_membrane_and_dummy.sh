...
gmx grompp -f mdp/step6.2_equilibration.mdp -p topol.top -n index.ndx -c step6.6_equilibration_last.gro -r step6.6_equilibration_last.gro -o out/step6.2_equilibration.tpr
