...
STEP3_OUTPUT_PATH="/cluster/projects/nn4654k/samiran/BILAYERMIX_PROJECT/examples/ecoli/prepare_gromacs/ecoli-complete-from10.3x10.3x8.5/controlledelongation/step3_NVT/gromacs_out"
# modify topol.top
...
cp -r topol.top toppar mdp ${SCRATCH}/.
cd $SCRATCH
mkdir -p out

##extract last frame without dummy
...
echo -e "q" | gmx make_ndx -f ${STEP3_OUTPUT_PATH}/step6.6_equilibration.gro -o index.ndx
#
##run
## Minimization
...
gmx grompp -f mdp/step6.2_equilibration.mdp -p topol.top -n index.ndx -c ${STEP3_OUTPUT_PATH}/step6.6_equilibration.gro -r ${STEP3_OUTPUT_PATH}/step6.6_equilibration.gro -o out/step6.2_equilibration.tpr
